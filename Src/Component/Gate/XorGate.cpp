...
nts::XorGate::XorGate(const std::string &name, nts::IComponent *firstPin,
...
nts::XorGate::XorGate(XorGate &other) : AbstractComponent(other._name,
	nts::GATE)
{
...
nts::XorGate &nts::XorGate::operator=(XorGate &other)
{
	this->_pin[0] = other._pin[0];
	this->_pin[1] = other._pin[1];
	this->_pinLink[1] = other._pinLink[1];
...
nts::IComponent *nts::XorGate::Copy()
{
	return new XorGate(*this);
}

void nts::XorGate::setLink(std::size_t pin __attribute__((unused)),
...
void nts::XorGate::DefineLink(std::size_t pin __attribute__((unused)),
	nts::IComponent &other __attribute__((unused)),
	std::size_t otherPin __attribute__((unused)))
{
	throw SetLinkError(
...
nts::Tristate nts::XorGate::truthTableExec(nts::Tristate first, nts::Tristate second)
{
...
nts::Tristate nts::XorGate::compute(std::size_t pin __attribute__((unused)))
{
...
nts::IComponent *nts::XorGate::getPin()
{
	return *this->_pin;
}

std::unordered_map <std::size_t, std::size_t> nts::XorGate::getPinLink() const
{
