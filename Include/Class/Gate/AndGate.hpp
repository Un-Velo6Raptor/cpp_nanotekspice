...
namespace nts {
	...
	class AndGate : public AbstractComponent {
		public:
		// Constructor, Destructor
		AndGate(const std::string &name, nts::IComponent *firstPin, nts::IComponent *secondPin);
		~AndGate();

		// Copy constructor / operator
		AndGate(AndGate &other);
		AndGate &operator=(AndGate &other);
		IComponent *Copy();
